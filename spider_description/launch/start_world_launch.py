...
*  Description:         Use this file to launch spider warehouse world in gazebo simulator 
*  Created:				07/09/2025
...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument(
          'world',
          default_value=[os.path.join(pkg_models_dir, 'worlds', 'spider_warehouse.world'), ''], # Change name of world file if required.
